...
class DonationCreateView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            # Update goals
            self.update_goals(transaction.amount)
            
            # Send confirmation email
            self.send_confirmation_email(transaction)
            
            messages.success(
                request,
                f'Thank you for your donation of {transaction.get_amount_display()}!'
            )
    ...
    def update_goals(self, amount):
        """Update all active goals with the donation"""
