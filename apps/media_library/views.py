...
class GalleryView(ListView):
    ...
    def get_queryset(self):
        ...
        return Media.objects.filter(media_type='image').select_related(
            'uploaded_by'
...
class GalleryCategoryView(ListView):
    ...
    def get_queryset(self):
        ...
        return Media.objects.filter(
            media_type='image', categories=self.category
        ).order_by('-created_at')
...
class MediaUploadView(LoginRequiredMixin, UserPassesTestMixin, View):
